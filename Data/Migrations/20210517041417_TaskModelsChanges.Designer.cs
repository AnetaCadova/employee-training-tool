...
namespace employee_training_tool.DataMigrations
{
    ...
    [Migration("20210517041417_TaskModelsChanges")]
    partial class TaskModelsChanges
    {
            ...
            modelBuilder.Entity("employee_training_tool.Models.AssignedTask", b =>
                {
                    ...
                    b.HasOne("employee_training_tool.Models.CatalogTask", "CatalogTask")
                        .WithMany()
